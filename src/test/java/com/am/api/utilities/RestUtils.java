...
import com.am.api.reporting.ExtentReportManager;
...
public class RestUtils {
    ...
    private static void printRequestLogInReport(RequestSpecification requestSpecification) {
        ...
        if(queryableRequestSpecification.getBody()!=null){
            ExtentReportManager.logJson((String) queryableRequestSpecification.getBody());
        }
    }
    ...
    public static Response performGet(String endPoint, Map<String,String>headers) {
        RequestSpecification requestSpecification = getRequestSpecificationWithQueryParams(endPoint, headers);
    ...
    private static RequestSpecification getRequestSpecificationWithQueryParams(String endPoint, Map<String, String> headers) {
         return RestAssured.given()
                .baseUri(endPoint)
                //.headers(headers)
